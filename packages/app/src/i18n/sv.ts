export const dict = {
  ...
  "command.model.variant.cycle": "Växla tankeinsats",
  ...
  "provider.connect.status.waiting": "Väntar på auktorisation...",
  ...
  "prompt.placeholder.shell": "Ange shellkommando... {{example}}",
  ...
  "prompt.dropzone.file.label": "Släpp till @mention-fil",
  ...
  "prompt.menu.shellCommand": "Shellkommando",
  ...
  "prompt.toast.shellSendFailed.title": "Det gick inte att skicka shellkommandot",
  ...
  "dialog.plugins.empty": "Plugins konfigurerade i opencode.json",
  ...
  "dialog.directory.parent": "Överordnad",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenCode inte installerad",
  ...
  "wsl.onboarding.wslNotInstalled.title": "WSL inte installerat",
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan OpenCode kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL inte tillgänglig",
  ...
  "dialog.project.edit.icon.recommended": "Rekommenderad: 128x128px",
  "dialog.project.edit.color": "Färg",
  "dialog.project.edit.color.select": "Välj {{color}} färg",
  ...
  "context.stats.reasoningTokens": "Resonerande tokens",
  ...
  "toast.permissions.autoaccept.on.description": "Tillståndsbegäranden kommer att godkännas automatiskt",
  "toast.permissions.autoaccept.off.title": "Slutade att automatiskt acceptera behörigheter",
  "toast.permissions.autoaccept.off.description": "Begäran om tillstånd kräver godkännande",
  ...
  "notification.permission.title": "Tillstånd krävs",
  "notification.permission.description": "{{sessionTitle}} i {{projectName}} behöver tillstånd",
  ...
  "session.review.noVcs.createGit.title": "Skapa ett Git-förråd",
  ...
  "session.review.noVcs.createGit.action": "Skapa Git-förråd",
  "session.review.noSnapshot":
    "Spårning av ögonblicksbilder är inaktiverat i konfigurationen, så sessionsändringar är inte tillgängliga",
  ...
  "session.header.reveal.containingFolder": "Öppna innehållande mapp",
  ...
  "settings.general.section.notifications": "Systemmeddelanden",
  ...
  "settings.general.row.shell.description": "Shell som används av terminalen och agentverktygen",
  ...
  "settings.general.row.pinchZoom.description": "Tillåt styrplattan att nypa och Ctrl-rulla gester för att zooma",
  ...
  "settings.updates.row.check.description":
    "Kontrollera manuellt efter uppdateringar och installera om det är tillgängligt",
  ...
  "settings.general.sounds.permissions.description": "Spela upp ljud när tillstånd krävs",
  ...
  "settings.providers.connected.environmentDescription": "Ansluten från dina miljövariabler",
  ...
  "settings.permissions.tool.bash.description": "Kör shellkommandon",
  ...
  "settings.permissions.tool.doom_loop.description": "Upptäck upprepade verktygsanrop med identisk ingång",

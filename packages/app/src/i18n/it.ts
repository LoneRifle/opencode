export const dict = {
  "command.category.suggested": "Suggerito",
  ...
  "command.sidebar.toggle": "Attiva/disattiva la barra laterale",
  ...
  "command.input.focus": "Attiva il campo di input",
  "command.terminal.toggle": "Attiva/disattiva terminale",
  "command.fileTree.toggle": "Attiva/disattiva l'albero dei file",
  "command.review.toggle": "Attiva/disattiva la revisione",
  ...
  "command.mcp.toggle": "Attiva/disattiva MCPs",
  "command.mcp.toggle.description": "Attiva/disattiva MCPs",
  ...
  "command.prompt.mode.normal": "Richiesta",
  ...
  "command.workspace.toggle": "Attiva/disattiva le aree di lavoro",
  ...
  "command.session.share.description": "Condividi questa sessione e copia URL negli appunti",
  ...
  "dialog.provider.openai.note": "Modelli GPT per attività di IA generica rapide e avanzate",
  ...
  "dialog.model.empty": "Nessun risultato del modello",
  ...
  "dialog.model.unpaid.viewMoreProviders": "Scopri altri 70+ provider",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la tua chiave {{provider}} API per connettere il tuo account e utilizzare i modelli {{provider}} in OpenCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "OpenCode Zen ti dà accesso a una serie curata di modelli ottimizzati affidabili per gli agenti di codifica.",
  ...
  "provider.custom.headers.key.placeholder": "Nome-intestazione",
  ...
  "provider.custom.error.baseURL.required": "La base URL è obbligatoria",
  ...
  "prompt.mode.normal": "Richiesta",
  "prompt.mode.shell.exit": "esc per uscire",
  "session.child.promptDisabled": "Non è possibile inviare richieste alle sessioni dei subagenti.",
  ...
  "prompt.example.3": "Correggi i test interrotti",
  "prompt.example.4": "Spiega come funziona l'autenticazione",
  "prompt.example.5": "Trova e correggi le vulnerabilità della sicurezza",
  ...
  "prompt.example.15": "Esamina il mio codice per le migliori pratiche",
  ...
  "prompt.example.19": "Aggiungi la registrazione in tutta la codebase",
  "prompt.example.20": "Quali dipendenze sono obsolete?",
  "prompt.example.21": "Aiutami a scrivere uno script di migrazione",
  "prompt.example.22": "Implementa la memorizzazione nella cache per questo endpoint",
  "prompt.example.23": "Aggiungi l'impaginazione a questo elenco",
  ...
  "prompt.toast.modelAgentRequired.description": "Scegli un agente e un modello prima di inviare una richiesta.",
  ...
  "prompt.toast.promptSendFailed.title": "Impossibile inviare la richiesta",
  ...
  "mcp.status.needs_auth": "necessita dell'autenticazione",
  ...
  "wsl.server.retryStart": "Riprova ad avviare",
  ...
  "wsl.onboarding.restartRequired": "Windows necessita di un riavvio per completare l'installazione WSL.",
  ...
  "wsl.onboarding.finishingDistro": "Configurazione finale per {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.missingTools": "bash e curl mancanti",
  ...
  "dialog.project.edit.icon.hint": "Fare clic o trascinare un'immagine",
  ...
  "dialog.project.edit.worktree.startup.description":
    "Viene eseguito dopo la creazione di un nuovo spazio di lavoro (worktree).",
  ...
  "context.breakdown.note":
    'Ripartizione approssimativa dei token di input. "Altro" include le definizioni degli strumenti e i costi generali.',
  ...
  "context.usage.clickToView": "Fare clic per visualizzare il contesto",
  ...
  "toast.permissions.autoaccept.off.title": "Arrestata l'accettazione automatica delle autorizzazioni",
  ...
  "toast.session.share.copyFailed.title": "Impossibile copiare URL negli appunti",
  ...
  "directory.error.invalidUrl": "Directory non valida in URL.",
  ...
  "home.recentlyClosed": "Chiuso di recente",
  ...
  "home.sessions.empty": "Niente qui ancora",
  ...
  "session.review.noSnapshot":
    "Il tracciamento delle istantanee è disabilitato nella configurazione, quindi le modifiche alla sessione non sono disponibili",
  "session.review.noChanges": "Nessuna modifica",
  "session.review.noUncommittedChanges": "Nessuna modifica ancora non confermata",
  "session.review.noBranchChanges": "Nessuna modifica del branch",
  ...
  "session.question.minimize": "Riduci al minimo la domanda",
  ...
  "session.new.worktree.main": "Ramo principale",
  "session.new.worktree.mainWithBranch": "Ramo principale ({{branch}})",
  ...
  "session.new.workspace.existing": "Spazio di lavoro...",
  ...
  "session.header.open.menu": "Apri le opzioni",
  ...
  "session.header.reveal.finder": "Rivela in Finder",
  "session.header.reveal.fileExplorer": "Rivela in File Explorer",
  ...
  "prompt.loading": "Caricamento richiesta...",
  ...
  "common.moreOptions": "Più opzioni",
  ...
  "debugBar.frame.tip": "Peggiore frame time negli ultimi 5 secondi.",
  "debugBar.jank.label": "JANK",
  "debugBar.jank.tip": "Fotogrammi superiori a 32 ms negli ultimi 5 secondi.",
  "debugBar.long.label": "LONG",
  "debugBar.long.tip":
    "Conteggio del tempo bloccato e delle attività lunghe negli ultimi 5 secondi. Compito massimo: {{max}}.",
  "debugBar.delay.label": "DELAY",
  "debugBar.delay.tip": "Peggiore ritardo di input osservato negli ultimi 5 secondi.",
  "debugBar.inp.label": "INP",
  "debugBar.inp.tip":
    "Durata approssimativa dell'interazione negli ultimi 5 secondi. Questo è simile a INP, non il Web Vitals INP ufficiale.",
  ...
  "settings.general.row.followup.title": "Comportamento successivo",
  "settings.general.row.followup.description":
    "Scegli se le richieste di follow-up guidano immediatamente o attendono in coda",
  ...
  "settings.general.row.showSearch.title": "Tavolozza dei comandi",
  "settings.general.row.showSearch.description":
    "Mostra il pulsante della palette di ricerca e comando nella barra del titolo",
  ...
  "settings.general.row.showCustomAgents.description":
    "Passa da un agente all'altro nell'editor. Se nascosto, viene usato l'agente Build.",
  ...
  "settings.general.row.shellToolPartsExpanded.description":
    "Mostra le parti dello strumento Shell espanse per impostazione predefinita nella timeline",
  ...
  "settings.general.row.wayland.tooltip":
    "Su Linux con monitor con frequenza di aggiornamento mista, Wayland nativo può essere più stabile.",
  ...
  "settings.general.notifications.agent.description":
    "Mostra la notifica di sistema quando l'agente è completo o necessita di attenzione",
  ...
  "settings.general.sounds.agent.description":
    "Riproduci un suono quando l'agente è completo o necessita di attenzione",
  ...
  "settings.shortcuts.reset.toast.title": "Reset delle scorciatoie",
  ...
  "settings.shortcuts.pressKeys": "Premere i tasti",
  ...
  "settings.shortcuts.group.prompt": "Richiesta",
  ...
  "settings.providers.connected.environmentDescription": "Connesso dalle variabili di ambiente",
  "settings.providers.section.popular": "Provider più diffusi",
  "settings.providers.custom.description": "Aggiungi un provider compatibile con OpenAI per base URL.",
  ...
  "settings.permissions.tool.glob.description": "Abbina i file utilizzando modelli glob",
  ...
  "workspace.reset.success.title": "Reimpostazione dell'area di lavoro",
  "workspace.reset.success.description": "L'area di lavoro ora corrisponde al ramo predefinito.",
  "workspace.error.stillPreparing": "L'area di lavoro è ancora in preparazione",
  "workspace.status.checking": "Verifica delle modifiche non unite in corso...",
  "workspace.status.error": "Impossibile verificare lo stato di Git.",
  "workspace.status.clean": "Nessuna modifica non unita rilevata.",
  "workspace.status.dirty": "Modifiche non unite rilevate in quest'area di lavoro.",
  ...
  "workspace.reset.note": "Ciò ripristinerà l'area di lavoro in modo che corrisponda al ramo predefinito.",
}

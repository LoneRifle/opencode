export const dict = {
  "command.category.suggested": "सुझाव दिया",
  "command.category.view": "देखना",
  ...
  "command.message.previous": "पिछले संदेश",
  ...
  "command.model.variant.cycle": "विचार प्रयास बदलें",
  ...
  "command.session.redo": "दोबारा करें",
  "command.session.redo.description": "अंतिम पूर्ववत संदेश को पुनः करें",
  "command.session.compact": "कॉम्पैक्ट सेशन",
  ...
  "command.session.unshare": "सेशन को अनशेयर करें",
  "command.session.unshare.description": "इस सेशन को साझा करना बंद करें",
  "palette.search.placeholder": "फ़ाइलें खोजें, कमांड, और सेशन",
  ...
  "dialog.provider.anthropic.note": "प्रो और मैक्स सहित Claude मॉडल तक सीधी पहुंच",
  ...
  "dialog.provider.openrouter.note": "एक प्रोवाइडर से सभी समर्थित मॉडल तक पहुंचें",
  "dialog.provider.vercel.note": "स्मार्ट रूटिंग के साथ AI मॉडल तक एकीकृत पहुंच",
  ...
  "dialog.model.manage.description": "अनुकूलित करें कि मॉडल चयनकर्ता में कौन सा मॉडल दिखाई दे।",
  "dialog.model.manage.provider.toggle": "सभी {{provider}} मॉडल को टॉगल करें",
  "dialog.model.unpaid.freeModels.title": "OpenCode द्वारा निःशुल्क मॉडल प्रदान किया गया",
  ...
  "dialog.provider.viewAll": "और अधिक दिखाएँ प्रोवाइडर",
  ...
  "provider.connect.status.waiting": "प्राधिकरण के लिए इंतजार करो...",
  ...
  "provider.connect.opencodeZen.line1": "OpenCode Zen आपको एजेंट कोडिंग के लिए विश्वसनीय अनुकूलित मॉडल के क्यूरेटेड सेट तक पहुंच प्रदान करता है।",
  "provider.connect.opencodeZen.line2": "एक एकल API कुंजी के साथ आपको मॉडल जैसे Claude, GPT, Gemini, GLM और अधिक तक पहुंच प्राप्त होगी।",
  ...
  "provider.connect.oauth.code.placeholder": "प्राधिकरण संकेत - लिपि",
  ...
  "provider.connect.toast.connected.title": "{{provider}} जुड़ा हुआ है",
  "provider.connect.toast.connected.description": "{{provider}} मॉडल अब उपयोग के लिए उपलब्ध है।",
  ...
  "session.child.promptDisabled": "सबएजेंट सेशन को संकेत नहीं दिया जा सकता।",
  ...
  "prompt.example.7": "इस फ़ंक्शन को अधिक पठनीय बनाने के लिए इसे पुन: सक्रिय करें",
  ...
  "prompt.example.13": "इसके लिए एक नया घटक बनाएं...",
  ...
  "prompt.popover.emptyCommands": "कोई मिलान नहीं कमांड",
  "prompt.dropzone.label": "छवियाँ, PDFs, या टेक्स्ट फ़ाइलें यहां छोड़ें",
  "prompt.dropzone.file.label": "@उल्लेख फ़ाइल पर छोड़ें",
  "prompt.slash.badge.custom": "रिवाज़",
  "prompt.slash.badge.skill": "कौशल",
  "prompt.slash.badge.mcp": "एमसीपी",
  ...
  "prompt.action.attachFile": "फाइलें जोड़ो",
  ...
  "prompt.action.send": "भेजना",
  "prompt.action.stop": "रुकना",
  ...
  "dialog.mcp.empty": "कोई MCPs कॉन्फ़िगर नहीं किया गया",
  "dialog.lsp.empty": "LSPs फ़ाइल प्रकारों से स्वतः पता लगाया गया",
  "dialog.plugins.empty": "प्लगइन्स opencode.json में कॉन्फ़िगर किया गया है",
  "mcp.status.connected": "जुड़े हुए",
  ...
  "dialog.fork.empty": "फ़ोर्क को कोई संदेश नहीं",
  ...
  "dialog.directory.root": "जड़",
  "dialog.directory.parent": "माता-पिता",
  "dialog.directory.readError": "इस फ़ोल्डर को पढ़ने में असमर्थ",
  "app.server.unreachable": "{{server}} तक नहीं पहुंच सका",
  ...
  "wsl.onboarding.restartRequired": "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ की आवश्यकता है।",
  "wsl.onboarding.ready": "WSL तैयार है.",
  "wsl.onboarding.required": "WSL को जारी रखना आवश्यक है।",
  ...
  "wsl.onboarding.listingDistros": "सूची वितरण...",
  "wsl.onboarding.distroReady": "{{distro}} तैयार है.",
  "wsl.onboarding.distroNotInstalled": "{{distro}} अभी तक स्थापित नहीं है.",
  "wsl.onboarding.openDistroOnce": "सेटअप पूरा करने के लिए एक बार {{distro}} खोलें।",
  "wsl.onboarding.finishingDistro": "{{distro}} के लिए फिनिशिंग सेटअप।",
  ...
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} में OpenCode अपडेट कर रहा है...",
  ...
  "wsl.onboarding.checkAgain": "फिर से जाँचो",
  ...
  "wsl.onboarding.refresh": "ताज़ा करना",
  "wsl.onboarding.allDistrosAdded": "सभी स्थापित डिस्ट्रो पहले ही जोड़े जा चुके हैं।",
  "wsl.onboarding.noDistros": "अभी तक कोई डिस्ट्रोज़ नहीं मिला.",
  "wsl.onboarding.install": "स्थापित करना",
  ...
  "dialog.project.edit.worktree.startup.placeholder": "जैसे बन स्थापित करें",
  "dialog.releaseNotes.action.getStarted": "शुरू करें",
  "dialog.releaseNotes.action.next": "अगला",
  "dialog.releaseNotes.action.hideFuture": "भविष्य में इन्हें न दिखाएं",
  "dialog.releaseNotes.media.alt": "रिहाई पूर्वावलोकन",
  "context.breakdown.title": "कॉन्टेक्स्ट ब्रेकडाउन",
  "context.breakdown.note": "इनपुट टोकन का अनुमानित टूटना। \"अन्य\" में टूल परिभाषाएँ और ओवरहेड शामिल हैं।",
  ...
  "context.stats.messages": "संदेशों",
  ...
  "toast.session.share.success.description": "साझा करें URL को क्लिपबोर्ड पर कॉपी किया गया!",
  ...
  "toast.update.action.notYet": "अभी तक नहीं",
  "error.page.title": "कुछ गलत हो गया",
  "error.page.description": "एप्लिकेशन लोड करते समय एक त्रुटि उत्पन्न हुई.",
  "error.page.description.localServerStartup": "स्थानीय सर्वर प्रारंभ करते समय एक त्रुटि उत्पन्न हुई.",
  ...
  "error.chain.providerInitFailed": "प्रोवाइडर \"{{provider}}\" प्रारंभ करने में विफल। क्रेडेंशियल्स और कॉन्फ़िगरेशन की जाँच करें.",
  ...
  "error.chain.configDirectoryTypo": "{{path}} में निर्देशिका \"{{dir}}\" मान्य नहीं है। निर्देशिका का नाम बदलकर \"{{suggestion}}\" करें या इसे हटा दें। यह एक सामान्य टाइपो है.",
  ...
  "notification.question.title": "सवाल",
  ...
  "home.recentProjects": "हाल ही में प्रोजेक्ट",
  ...
  "session.review.filesChanged": "फ़ाइलें परिवर्तित {{count}}",
  ...
  "session.review.noVcs.createGit.actionLoading": "Git रिपॉजिटरी बनाया जा रहा है...",
  ...
  "session.todo.title": "सब",
  "session.todo.collapse": "गिर जाना",
  "session.todo.expand": "बढ़ाना",
  "session.todo.progress": "{{total}} का {{done}} कार्य पूरा हुआ",
  "session.question.progress": "{{total}} प्रश्नों में से {{current}}",
  "session.question.minimize": "प्रश्न कम से कम करें",
  ...
  "session.followupDock.summary.one": "{{count}} पंक्तिबद्ध संदेश",
  "session.followupDock.summary.other": "{{count}} पंक्तिबद्ध संदेश",
  "session.followupDock.sendNow": "अब भेजें",
  "session.followupDock.edit": "संपादन करना",
  "session.followupDock.collapse": "पंक्तिबद्ध संदेशों को संक्षिप्त करें",
  "session.followupDock.expand": "पंक्तिबद्ध संदेशों का विस्तार करें",
  "session.revertDock.summary.one": "{{count}} ने संदेश वापस ले लिया",
  "session.revertDock.summary.other": "{{count}} ने संदेशों को वापस ले लिया",
  ...
  "session.new.workspace.runIn": "सेशन को अंदर चलाएँ",
  "session.new.workspace.triggerLocal": "स्थानीय",
  "session.new.workspace.local": "स्थानीय भंडार",
  ...
  "session.header.reveal.containingFolder": "धारक फोल्डर खोलें",
  ...
  "session.share.action.share": "शेयर करना",
  "session.share.action.publish": "प्रकाशित करना",
  "session.share.action.publishing": "प्रकाशन...",
  "session.share.action.unpublish": "अप्रकाशित करें",
  "session.share.action.unpublishing": "अप्रकाशन...",
  "session.share.action.view": "देखना",
  "session.share.copy.copied": "कॉपी किया गया",
  "session.share.copy.copyLink": "लिंक की प्रतिलिपि करें",
  ...
  "common.key.space": "अंतरिक्ष",
  "common.key.backspace": "बैकस्पेस",
  "common.key.enter": "प्रवेश करना",
  "common.key.tab": "टैब",
  "common.key.delete": "मिटाना",
  "common.key.home": "घर",
  "common.key.end": "अंत",
  "common.key.pageUp": "पेज अप",
  "common.key.pageDown": "पेज नीचे",
  "common.key.insert": "डालना",
  ...
  "sidebar.gettingStarted.title": "शुरू करना",
  "sidebar.gettingStarted.line1": "OpenCode में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।",
  "sidebar.gettingStarted.line2": "मॉडल, inc का उपयोग करने के लिए किसी भी प्रोवाइडर को कनेक्ट करें। Claude, GPT, Gemini आदि।",
  "sidebar.project.recentSessions": "हाल ही में सेशन",
  "sidebar.project.viewAllSessions": "सभी सेशन देखें",
  "sidebar.project.clearNotifications": "स्पष्ट सूचनाएं",
  ...
  "debugBar.long.tip": "अंतिम 5 सेकंड में अवरुद्ध समय और लंबे कार्य की गिनती। अधिकतम कार्य: {{max}}.",
  ...
  "debugBar.mem.tipUnavailable": "प्रयुक्त JS हीप बनाम हीप सीमा। केवल Chromium.",
  "debugBar.mem.tip": "प्रयुक्त JS हीप बनाम हीप सीमा। {{limit}} का {{used}}.",
  ...
  "settings.general.section.advanced": "विकसित",
  ...
  "settings.general.section.feed": "खिलाना",
  ...
  "settings.general.row.colorScheme.description": "चुनें कि क्या OpenCode सिस्टम का अनुसरण करता है, प्रकाश, या अंधेरा थीम",
  ...
  "settings.general.row.followup.option.steer": "रास्ते पर लाना",
  ...
  "settings.general.row.newInterface.title": "नए विन्यास",
  ...
  "settings.general.row.newInterfaceNotice.dismiss": "नकार देना",
  ...
  "settings.general.row.wayland.title": "देशी Wayland का प्रयोग करें",
  "settings.general.row.wayland.description": "Wayland पर X11 फ़ॉलबैक अक्षम करें। पुनरारंभ की आवश्यकता है.",
  "settings.general.row.wayland.tooltip": "मिश्रित ताज़ा दर मॉनिटर के साथ Linux पर, देशी Wayland अधिक स्थिर हो सकता है।",
  "settings.general.row.releaseNotes.title": "रिलीज नोट्स",
  ...
  "settings.updates.row.startup.description": "OpenCode लॉन्च होने पर स्वचालित रूप से अपडेट की जांच करें",
  ...
  "settings.updates.action.checkNow": "अब जांचें",
  ...
  "settings.general.notifications.permissions.title": "अनुमतियां",
  ...
  "settings.general.sounds.permissions.title": "अनुमतियां",
  ...
  "settings.shortcuts.title": "कुंजीपटल अल्प मार्ग",
  ...
  "settings.shortcuts.pressKeys": "कुँजियाँ दबाएँ",
  ...
  "settings.shortcuts.group.navigation": "मार्गदर्शन",
  ...
  "settings.providers.connected.environmentDescription": "आपके पर्यावरण चर से जुड़ा हुआ",
  ...
  "settings.providers.tag.custom": "रिवाज़",
  ...
  "settings.permissions.section.tools": "औजार",
  "settings.permissions.toast.updateFailed.title": "अनुमतियाँ अद्यतन करने में विफल",
  "settings.permissions.action.allow": "अनुमति दें",
  "settings.permissions.action.ask": "पूछना",
  "settings.permissions.action.deny": "अस्वीकार करना",
  "settings.permissions.tool.read.title": "पढ़ना",
  "settings.permissions.tool.read.description": "फ़ाइल पढ़ना (फ़ाइल पथ से मेल खाता है)",
  "settings.permissions.tool.edit.title": "संपादन करना",
  ...
  "settings.permissions.tool.task.title": "काम",
  ...
  "workspace.status.checking": "असंबद्ध परिवर्तनों की जाँच की जा रही है...",
  "workspace.status.error": "Git स्थिति सत्यापित करने में असमर्थ.",
  "workspace.status.clean": "कोई भी असंबद्ध परिवर्तन नहीं पाया गया.",
  "workspace.status.dirty": "इस वर्कस्पेस में असंबद्ध परिवर्तन पाए गए।",
  ...
  "workspace.reset.archived.none": "कोई सक्रिय सेशन संग्रहीत नहीं किया जाएगा.",
  "workspace.reset.archived.one": "1 सेशन संग्रहीत किया जाएगा.",
  "workspace.reset.archived.many": "{{count}} सेशन संग्रहीत किया जाएगा.",

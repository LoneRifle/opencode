export const dict = {
  ...
  "command.category.provider": "فراہم کرن آلا",
  ...
  "command.session.previous.unseen": "پچھلا ان ریڈ سیشن",
  "command.session.next.unseen": "اگلا ان ریڈ سیشن",
  "command.session.archive": "آرکائیو سیشن",
  "command.palette": "کمانڈ پیلیٹ",
  "command.theme.cycle": "سائیکل تھیم",
  "command.theme.set": "تھیم ورتو: {{theme}}",
  "command.theme.scheme.cycle": "سائیکل رنگ سکیم",
  "command.theme.scheme.set": "رنگ سکیم ورتو: {{scheme}}",
  "command.language.cycle": "سائیکل بولی",
  ...
  "command.agent.cycle": "سائیکل ایجنٹ",
  "command.agent.cycle.description": "اگلے ایجنٹ تے سوئچ کرو",
  "command.agent.cycle.reverse": "سائیکل ایجنٹ نوں پچھے ول",
  "command.agent.cycle.reverse.description": "پچھلے ایجنٹ تے سوئچ کرو",
  "command.model.variant.cycle": "سائیکل سوچ دی کوشش",
  "command.model.variant.cycle.description": "اگلی کوشش دی سطح تے سوئچ کرو",
  "command.prompt.mode.shell": "Shell",
  "command.prompt.mode.normal": "فوری",
  ...
  "command.workspace.toggle": "کم دیاں تھاواں نوں ٹوگل کرو",
  ...
  "command.session.compact": "کمپیکٹ سیشن",
  ...
  "dialog.provider.search.placeholder": "فراہم کرن آلیاں دی تلاش کرو",
  "dialog.provider.empty": "کوئی فراہم کرن آلا نئیں ملیا",
  "dialog.provider.group.popular": "مشہور",
  "dialog.provider.group.other": "دوجے",
  "dialog.provider.custom.label": "کسٹم OpenAI-مطابقت آلا فراہم کرن آلا",
  ...
  "dialog.provider.openai.note": "تیز، قابل عام اے آئی کماں لئی ماڈل",
  "dialog.provider.google.note": "Gemini تیز، منظم ردعمل دے لیی ماڈل",
  "dialog.provider.openrouter.note": "اک فراہم کرن آلے توں تمام معاون ماڈل تک رسائی حاصل کرو",
  ...
  "dialog.model.empty": "کوئی ماڈل دا نتیجہ نئیں",
  ...
  "dialog.model.manage.provider.toggle": "سارے {{provider}} ماڈلاں نو ٹوگل کرو",
  "dialog.model.unpaid.freeModels.title": "OpenCode دے ذریعہ فراہم کردہ مفت ماڈل",
  "dialog.model.unpaid.addMore.title": "مقبول فراہم کرن آلیاں توں ہور ماڈل شامل کرو",
  "dialog.model.unpaid.viewMoreProviders": "70+ ہور فراہم کرن آلے ویکھو",
  "dialog.provider.viewAll": "ہور فراہم کرن آلے وکھاؤ",
  "provider.connect.title": "جڑو {{provider}}",
  ...
  "provider.connect.status.inProgress": "اتھارٹی جاری اے...",
  "provider.connect.status.waiting": "اجازت دا انتظار کر رئے آں...",
  "provider.connect.status.failed": "اجازت ناکام ہو گئی: {{error}}",
  ...
  "provider.connect.oauth.code.placeholder": "اتھارٹی کوڈ",
  "provider.connect.oauth.code.required": "اتھارٹی کوڈ دی لوڑ اے",
  ...
  "provider.custom.title": "اپنی مرضی دے مطابق فراہم کرن آلا",
  "provider.custom.description.prefix": "OpenAI نال مطابقت رکھن والا کسٹم پرووائیڈر ترتیب دیو۔ ویکھو ",
  "provider.custom.description.link": "فراہم کرن آلے دی ترتیب دے دستاویزات",
  "provider.custom.description.suffix": ".",
  "provider.custom.field.providerID.label": "فراہم کرن آلے دی شناخت",
  "provider.custom.field.providerID.placeholder": "میرا فراہم کرن آلا",
  ...
  "provider.custom.models.name.label": "ناں دینا",
  ...
  "provider.custom.error.providerID.exists": "اوہ فراہم کرن آلا آئی ڈی پہلے توں موجود اے",
  ...
  "provider.custom.error.required": "ضرورت اے",
  "provider.custom.error.duplicate": "نقل",
  ...
  "common.save": "بچاندا اے",
  "common.saving": "بچا رہیا اے...",
  ...
  "prompt.example.2": "اس منصوبے دا ٹیک اسٹیک کی اے؟",
  ...
  "prompt.example.13": "لئی اک نواں جزو بناؤ...",
  "prompt.example.14": "میں اس منصوبے نو کیویں تعینات کراں؟",
  ...
  "dialog.mcp.description": "{{enabled}} of {{total}} فعال",
  "dialog.mcp.empty": "کوئی MCPs تشکیل نئیں دتا گیا",
  "dialog.lsp.empty": "LSPs فائل دی اقسام توں خودکار طور تے پتہ چلدا اے",
  "dialog.plugins.empty": "اوپن کوڈ ڈاٹ جے ایسون چ ترتیب دتے گئے پلگ انز",
  "mcp.status.connected": "جڑیا ہویا",
  "mcp.status.failed": "ناکام ہویا",
  "mcp.status.needs_auth": "تصدیق دی لوڑ اے",
  "mcp.status.disabled": "نااہل بناؤ",
  ...
  "dialog.directory.parent": "ماں پیو",
  ...
  "app.server.otherServers": "دوجے سرورز",
  ...
  "dialog.server.menu.edit": "تدوین کرنا",
  "dialog.server.menu.default": "ڈیفالٹ دے طور تے سیٹ کرو",
  "dialog.server.menu.defaultRemove": "پہلے توں طے شدہ ہٹا دیو",
  ...
  "wsl.onboarding.restartRequired": "Windows نو انسٹال کرن نو ختم کرن دے لیی دوبارہ شروع کرن دی لوڑ اے۔",
  ...
  "wsl.onboarding.finishingDistro": "{{distro}} لئی سیٹ اپ ختم کرنا۔",
  ...
  "wsl.onboarding.updateOpencode": "اپ ڈیٹ کرو OpenCode",
  ...
  "wsl.onboarding.distroStatus.ready": "تیار او",
  ...
  "wsl.onboarding.distroStatus.missingTools": "باس، کرل غائب اے",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windows Linux لئی سب سسٹم) دی لوڑ اے اس توں پہلاں کہ OpenCode اک WSL سرور شامل کر سکے",
  ...
  "wsl.onboarding.windowsRestartRequired": "WSL نو انسٹال کرن نو ختم کرن دے لیی Windows نو دوبارہ شروع کرو، فیر OpenCode نو دوبارہ کھولو۔",
  ...
  "wsl.onboarding.toolsRequired": "اس ڈسٹرو نو بیس تے کرل دی لوڑ اے۔",
  ...
  "dialog.project.edit.name": "ناں دینا",
  ...
  "dialog.releaseNotes.action.hideFuture": "ایناں نوں آن آلے ویلے چ نہ وکھاؤ",
  "dialog.releaseNotes.media.alt": "ریلیز پیش نظارہ",
  "context.breakdown.title": "سیاق و سباق دی ٹوٹ پھوٹ",
  "context.breakdown.note": "ان پٹ ٹوکناں دی لگ بھگ خرابی۔ \"ہور\" چ ٹول دی تعریفاں تے اوور ہیڈ شامل اے۔",
  ...
  "context.stats.provider": "فراہم کرن آلا",
  ...
  "toast.workspace.disabled.title": "کم دیاں تھاواں غیر فعال کر دتیاں گئیاں نیں",
  ...
  "toast.model.none.description": "اس سیشن دا خلاصہ کرن لئی کسے فراہم کرن آلے نال جڑو",
  ...
  "toast.session.share.success.description": "شیئر کرو URL کلپ بورڈ تے کاپی کیتا گیا!",
  ...
  "toast.session.unshare.success.title": "سیشن غیر شیئر کیتا گیا",
  "toast.session.unshare.success.description": "سیشن کامیابی نال غیر شیئر کیتا گیا!",
  ...
  "toast.project.reloadFailed.title": "دوبارہ لوڈ کرن چ ناکام {{project}}",
  ...
  "error.page.action.reported": "غلطی دی اطلاع دتی گئی",
  ...
  "error.childStore.persistedCacheCreateFailed": "مستقل کیشے بنان چ ناکام رہیا",
  ...
  "error.chain.responseBody": "جوابی ادارہ:\n{{body}}",
  "error.chain.didYouMean": "کی تہاڈا مطلب سی: {{suggestions}}",
  "error.chain.modelNotFound": "ماڈل نئیں لبیا: {{provider}}/{{model}}",
  "error.chain.checkConfig": "اپنی ترتیب (opencode.json) فراہم کرن آلے/ماڈل دے ناں چیک کرو",
  ...
  "error.chain.providerInitFailed": "فراہم کرن آلے \"{{provider}}\" نو شروع کرن چ ناکام رہیا۔ اسناد تے ترتیب چیک کرو۔",
  ...
  "home.empty.title": "کوئی حالیہ منصوبہ نئیں",
  "home.empty.description": "اک مقامی منصوبہ کھول کے شروع کرو",
  "home.title": "گھار",
  "home.projects": "منصوبے",
  "home.project.add": "پروجیکٹ شامل کرو",
  "home.recentlyClosed": "حال ای چ بند کیتا گیا",
  "home.server.collapse": "سرور دے منصوبیاں نو منہدم کرو",
  "home.server.expand": "سرور منصوبیاں نو ودھاؤ",
  ...
  "session.review.filesChanged": "فائلاں بدلیاں گئیاں {{count}}",
  "session.review.change.one": "تبدیل کرو",
  ...
  "session.review.noUncommittedChanges": "ہلے تیکر کوئی غیر پرعزم تبدیلی نئیں",
  ...
  "session.todo.expand": "توسیع کرنا",
  "session.todo.progress": "{{done}} دے {{total}} کم مکمل ہو گئے",
  "session.question.progress": "{{total}} سوالاں دا {{current}}",
  "session.question.minimize": "سوال نوں گھٹ توں گھٹ کرو",
  ...
  "session.followupDock.edit": "تدوین کرنا",
  "session.followupDock.collapse": "قطار چ لگے سنیہے ختم کرو",
  ...
  "session.revertDock.collapse": "کالپس رول بیک پیغامات",
  ...
  "session.header.open.copyPath": "کاپی دا راہ",
  ...
  "session.header.reveal.containingFolder": "کنٹیننگ فولڈر کھولو",
  ...
  "session.share.action.publishing": "پبلشنگ...",
  "session.share.action.unpublish": "شائع نہ کرو",
  "session.share.action.unpublishing": "غیر شائع ہون آلا...",
  "session.share.action.view": "نظارہ",
  ...
  "common.archive": "آرکائیو کیتا",
  "common.delete": "مکاؤ",
  "common.close": "بند کرو",
  "common.edit": "تدوین کرنا",
  ...
  "sidebar.nav.projectsAndSessions": "منصوبے تے سیشن",
  "sidebar.settings": "ترتیبات",
  "sidebar.help": "‏‏مدد کرنا",
  "sidebar.workspaces.enable": "کم دیاں تھاواں نوں فعال کرو",
  ...
  "sidebar.gettingStarted.line2": "کسے وی فراہم کرن آلے نو ماڈل، انکارپوریٹڈ استعمال کرن لئی جوڑو۔ Claude، GPT، Gemini وغیرہ",
  ...
  "debugBar.mem.tip": "جے ایس ہیپ بمقابلہ ہیپ لیمٹ استعمال کیتا گیا۔ {{limit}} دا {{used}}۔",
  ...
  "settings.desktop.wsl.title": "انضمام",
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر OpenCode سرور چلاؤ۔",
  "settings.general.section.appearance": "دسنا",
  "settings.general.section.advanced": "وادھو",
  ...
  "settings.general.section.feed": "کھانا دینا",
  "settings.general.section.display": "وکھاؤ",
  ...
  "settings.general.row.appearance.title": "دسنا",
  ...
  "settings.general.row.showCustomAgents.title": "شو ایجنٹ",
  ...
  "settings.general.row.newInterface.title": "نواں ترتیب",
  ...
  "settings.general.row.newInterfaceNotice.title": "تسی ہن نواں ترتیب ورت ​​رئے او",
  ...
  "settings.general.row.releaseNotes.description": "اپ ڈیٹس دے بعد پاپ اپ نواں کی اے وکھاؤ",
  "settings.updates.row.startup.title": "اسٹارٹ اپ تے تازہ ترین معلومات چیک کرو",
  ...
  "settings.shortcuts.pressKeys": "چابیاں دباؤ",
  ...
  "settings.shortcuts.group.prompt": "فوری",
  "settings.providers.title": "فراہم کرن آلے",
  "settings.providers.description": "فراہم کرن آلے دی ترتیبات ایتھے ترتیب دے قابل ہون گیاں۔",
  "settings.providers.section.connected": "جڑے ہوئے فراہم کرن آلے",
  "settings.providers.connected.empty": "کوئی جڑیا ہویا فراہم کرن آلا نئیں",
  "settings.providers.connected.environmentDescription": "تہاڈے ماحول دے متغیراں توں جڑیا ہویا اے",
  "settings.providers.section.popular": "مقبول فراہم کرن آلے",
  "settings.providers.custom.description": "بیس URL دے ذریعہ OpenAI- مطابقت رکھن آلا فراہم کرن آلا شامل کرو۔",
  "settings.providers.tag.environment": "ماحول",
  "settings.providers.tag.config": "ترتیب",
  "settings.providers.tag.custom": "مخصوص",
  "settings.providers.tag.other": "دوجے",
  "settings.models.title": "ماڈل",
  "settings.models.description": "ماڈل دی ترتیبات ایتھے ترتیب دے قابل ہون گیاں۔",
  "settings.agents.title": "ایجنٹ",
  ...
  "settings.permissions.action.allow": "اجازت دینا",
  "settings.permissions.action.ask": "پچھنا",
  "settings.permissions.action.deny": "انکار کرنا",
  ...
  "settings.permissions.tool.edit.title": "تدوین کرنا",
  "settings.permissions.tool.edit.description": "فائلاں وچ ترمیم کرو، بشمول ترمیماں، لکھتاں تے پیچاں",
  "settings.permissions.tool.glob.title": "Glob",
  "settings.permissions.tool.glob.description": "گلوب پیٹرن دا استعمال کردے ہوئے فائلاں نوں ملاو",
  ...
  "settings.permissions.tool.todowrite.description": "ٹوٹو لسٹ نوں اپ ڈیٹ کرو",
  ...
  "workspace.status.error": "گٹ دی حیثیت دی تصدیق کرن توں قاصر۔",

export const dict = {
  ...
  "command.tab.reopenClosed": "Qapalı tabı yenidən açın",
  ...
  "provider.custom.field.apiKey.description":
    "İstəyə bağlı. Avtorizasiyanı başlıqlar vasitəsilə idarə edirsinizsə boş buraxın.",
  ...
  "model.tooltip.reasoning": "Əsaslandırma",
  ...
  "mcp.auth.clickToAuthenticate": "Doğrulamaq üçün klikləyin",
  ...
  "wsl.onboarding.step.distro": "Distro seçin",
  ...
  "wsl.onboarding.pickDistro": "Bir distro seçin və ya aşağıda birini quraşdırın.",
  ...
  "wsl.onboarding.chooseDistroFirst": "Əvvəlcə distro seçin.",
  ...
  "wsl.onboarding.needAnotherDistro": "Başqa bir distroya ehtiyacınız varmı?",
  ...
  "wsl.onboarding.installDistro": "Distro quraşdırın",
  "wsl.onboarding.searchDistros": "Distribütivləri axtar",
  "wsl.onboarding.wsl2Required": "WSL 2 tələb olunur.",
  "wsl.onboarding.toolsRequired": "Bu distroya bash və curl lazımdır.",
  ...
  "error.childStore.persistedCacheCreateFailed": "Davamlı keş yaratmaq alınmadı",
  "error.childStore.persistedProjectMetadataCreateFailed": "Davamlı layihə metadatasını yaratmaq alınmadı",
  "error.childStore.persistedProjectIconCreateFailed": "Davamlı layihə ikonasını yaratmaq alınmadı",
  "error.childStore.storeCreateFailed": "Yaddaş yaradıla bilmədi",
  ...
  "session.review.noVcs.createGit.actionLoading": "Git deposu yaradılır...",
  ...
  "session.question.minimize": "Sualı minimuma endir",
  "session.question.restore": "Sualı bərpa edin",
  "session.question.pending.one": "{{count}} gözlənilən sual",
  "session.question.pending.other": "{{count}} gözləyən suallar",
  ...
  "session.new.workspace.runIn": "Sessiyanı işə salın",
  ...
  "sidebar.gettingStarted.line2":
    "Claude, GPT, Gemini və s. kimi modelləri istifadə etmək üçün istənilən provayderi qoşun.",
  ...
  "debugBar.ariaLabel": "İnkişaf performansının diaqnostikası",
  "debugBar.na": "yox",
  "debugBar.nav.label": "NAV",
  "debugBar.nav.tip":
    "Seans səhifəsinə toxunan sonuncu tamamlanmış marşrut keçidi, marşrutlaşdırıcının başlanğıcından yerləşdikdən sonra ilk boyaya qədər ölçülür.",
  "debugBar.fps.label": "FPS",
  "debugBar.fps.tip": "Son 5 saniyə ərzində saniyədə yuvarlanan kadrlar.",
  "debugBar.frame.label": "FRAME",
  "debugBar.frame.tip": "Son 5 saniyə ərzində ən pis kadr vaxtı.",
  "debugBar.jank.label": "JANK",
  "debugBar.jank.tip": "Son 5 saniyədə 32 ms-dən çox kadrlar.",
  "debugBar.long.label": "LONG",
  "debugBar.long.tip": "Son 5 saniyədə bloklanmış vaxt və uzun tapşırıqların sayı. Maksimum tapşırıq: {{max}}.",
  "debugBar.delay.label": "DELAY",
  "debugBar.delay.tip": "Son 5 saniyədə müşahidə edilən ən pis giriş gecikməsi.",
  "debugBar.inp.label": "INP",
  "debugBar.inp.tip":
    "Son 5 saniyə ərzində təxmini qarşılıqlı əlaqə müddəti. Bu, rəsmi Web Vitals INP deyil, INP-yə bənzəyir.",
  "debugBar.cls.label": "CLS",
  "debugBar.cls.tip": "Cari tətbiqin ömrü üçün məcmu tərtibat dəyişikliyi.",
  ...
  "settings.general.row.shell.autoDefault": "Avtomatik (Defolt)",
  ...
  "settings.general.row.colorScheme.description": "OpenCode-un sistem, işıq və ya qaranlıq mövzunu izlədiyini seçin",
  ...
  "settings.general.row.uiFont.title": "UI şrifti",
  "settings.general.row.uiFont.description": "Bütün interfeysdə istifadə olunan şrifti fərdiləşdirin",
  "settings.general.row.followup.title": "Davam promptlarının davranışı",
  "settings.general.row.followup.description":
    "Davam promptlarının dərhal yönləndirilməsini və ya növbədə gözləməsini seçin",
  ...
  "settings.general.row.showNavigation.description": "İş masasının başlıq çubuğunda geri və irəli düymələri göstərin",
  ...
  "settings.general.row.showTerminal.description": "İş masasının başlıq çubuğunda terminal düyməsini göstərin",
  ...
  "settings.general.row.pinchZoom.description": "Trackpad çimdik və Ctrl-scroll jestlərinə böyütməyə icazə verin",
  ...
  "settings.updates.action.downloading": "Endirilir...",

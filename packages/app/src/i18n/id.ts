export const dict = {
  ...
  "wsl.onboarding.wslUnavailable.description": "OpenCode tidak dapat memverifikasi WSL di perangkat ini.",
  ...
  "session.review.filesChanged": "Berkas Berubah {{count}}",
  ...
  "session.new.workspace.runIn": "Jalankan sesi di",

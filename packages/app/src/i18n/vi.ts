export const dict = {
  ...
  "command.sidebar.toggle": "Chuyển đổi thanh bên",
  ...
  "command.server.switch": "Chuyển đổi máy chủ",
  ...
  "command.session.archive": "Phiên lưu trữ",
  ...
  "command.steps.toggle": "Chuyển đổi các bước",
  ...
  "command.mcp.toggle": "Chuyển đổi MCP",
  "command.mcp.toggle.description": "Chuyển đổi MCP",
  "command.agent.cycle": "Chuyển tác nhân",
  "command.agent.cycle.description": "Chuyển sang tác nhân tiếp theo",
  "command.agent.cycle.reverse": "Tác nhân chu kỳ ngược",
  ...
  "command.workspace.toggle": "Chuyển đổi không gian làm việc",
  ...
  "dialog.provider.opencode.note": "Các mô hình được tuyển chọn bao gồm Claude, GPT, Gemini và hơn thế nữa",
  ...
  "dialog.model.manage.provider.toggle": "Chuyển đổi tất cả các mô hình {{provider}}",
  ...
  "provider.connect.status.inProgress": "Đang tiến hành cấp phép...",
  "provider.connect.status.waiting": "Đang chờ cấp phép...",
  "provider.connect.status.failed": "Ủy quyền không thành công: {{error}}",
  "provider.connect.apiKey.description": "Nhập khóa {{provider}} API của bạn để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong OpenCode.",
  ...
  "provider.connect.opencodeZen.line1": "OpenCode Zen cung cấp cho bạn quyền truy cập vào một tập hợp các mô hình được tối ưu hóa đáng tin cậy được tuyển chọn dành cho các tác nhân mã hóa.",
  ...
  "provider.connect.oauth.code.visit.suffix": " để thu thập mã ủy quyền của bạn nhằm kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong OpenCode.",
  ...
  "provider.custom.error.providerID.required": "Nhà cung cấp ID là bắt buộc",
  "provider.custom.error.providerID.format": "Sử dụng chữ cái viết thường, số, dấu gạch nối hoặc dấu gạch dưới",
  "provider.custom.error.providerID.exists": "Nhà cung cấp ID đó đã tồn tại",
  "provider.custom.error.name.required": "Tên hiển thị là bắt buộc",
  "provider.custom.error.baseURL.required": "Cơ sở URL là bắt buộc",
  ...
  "prompt.placeholder.summarizeComments": "Tổng hợp ý kiến…",
  "prompt.placeholder.summarizeComment": "Tổng hợp ý kiến…",
  "prompt.mode.shell": "Shell",
  "prompt.mode.normal": "Lời nhắc",
  "prompt.mode.shell.exit": "esc để thoát",
  "session.child.promptDisabled": "Phiên tác nhân phụ không thể được nhắc.",
  ...
  "prompt.example.7": "Cấu trúc lại chức năng này để dễ đọc hơn",
  ...
  "prompt.example.16": "Thêm xử lý lỗi vào chức năng này",
  ...
  "prompt.dropzone.file.label": "Thả vào tệp @mention",
  "prompt.slash.badge.custom": "tùy chỉnh",
  "prompt.slash.badge.skill": "kỹ năng",
  "prompt.slash.badge.mcp": "mcp",
  "prompt.context.active": "đang hoạt động",
  "prompt.context.includeActiveFile": "Bao gồm tập tin hoạt động",
  "prompt.context.removeActiveFile": "Xóa tệp đang hoạt động khỏi ngữ cảnh",
  "prompt.context.removeFile": "Xóa tệp khỏi ngữ cảnh",
  "prompt.action.attachFile": "Thêm tập tin",
  "prompt.menu.addImagesAndFiles": "Thêm tập tin và hơn thế nữa",
  "prompt.menu.imagesAndFiles": "Hình ảnh và tập tin",
  ...
  "prompt.toast.modelAgentRequired.title": "Chọn tác nhân và model",
  ...
  "dialog.directory.action.selectFile": "Chọn tập tin",
  "dialog.directory.action.selectFolder": "Chọn thư mục",
  "dialog.directory.root": "Gốc",
  "dialog.directory.parent": "cha mẹ",
  ...
  "dialog.server.description": "Chuyển đổi máy chủ OpenCode mà ứng dụng này kết nối tới.",
  "dialog.server.search.placeholder": "Máy chủ tìm kiếm",
  ...
  "wsl.server.menu.label": "WSL máy chủ",
  "wsl.server.retryStart": "Thử bắt đầu lại",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windows Hệ thống con cho Linux) là bắt buộc trước khi OpenCode có thể thêm máy chủ WSL",
  ...
  "wsl.onboarding.desktopVersion": "máy tính để bàn {{version}}",
  "wsl.onboarding.versionMismatch": "Phiên bản đã cài đặt không khớp với phiên bản ứng dụng dành cho máy tính để bàn.",
  ...
  "dialog.project.edit.worktree.startup.placeholder": "ví dụ. bun cài đặt",
  "dialog.releaseNotes.action.getStarted": "Bắt đầu",
  "dialog.releaseNotes.action.next": "Kế tiếp",
  "dialog.releaseNotes.action.hideFuture": "Không hiển thị những điều này trong tương lai",
  ...
  "toast.workspace.disabled.title": "Không gian làm việc bị vô hiệu hóa",
  ...
  "toast.permissions.autoaccept.on.description": "Yêu cầu cấp phép sẽ được tự động phê duyệt",
  "toast.permissions.autoaccept.off.title": "Đã dừng quyền tự động chấp nhận",
  "toast.permissions.autoaccept.off.description": "Yêu cầu cấp phép sẽ yêu cầu phê duyệt",
  ...
  "toast.file.loadFailed.title": "Không tải được tập tin",
  "toast.file.listFailed.title": "Không thể liệt kê các tập tin",
  ...
  "toast.session.share.success.title": "Phiên chia sẻ",
  "toast.session.share.success.description": "Chia sẻ URL được sao chép vào bảng tạm!",
  ...
  "toast.session.unshare.success.title": "Phiên không được chia sẻ",
  ...
  "error.childStore.persistedCacheCreateFailed": "Không tạo được bộ nhớ đệm liên tục",
  ...
  "error.childStore.storeCreateFailed": "Không tạo được cửa hàng",
  ...
  "error.chain.mcpFailed": "MCP máy chủ \"{{name}}\" không thành công. Lưu ý, OpenCode chưa hỗ trợ xác thực MCP.",
  "error.chain.providerAuthFailed": "Xác thực nhà cung cấp không thành công ({{provider}}): {{message}}",
  "error.chain.providerInitFailed": "Không khởi tạo được nhà cung cấp \"{{provider}}\". Kiểm tra thông tin xác thực và cấu hình.",
  "error.chain.configJsonInvalid": "Tệp cấu hình tại {{path}} không hợp lệ JSON(C)",
  "error.chain.configJsonInvalidWithMessage": "Tệp cấu hình tại {{path}} không hợp lệ JSON(C): {{message}}",
  ...
  "home.empty.description": "Bắt đầu bằng cách mở một dự án địa phương",
  ...
  "home.sessions.search.placeholder": "Phiên tìm kiếm",
  ...
  "home.sessions.group.older": "Lớn hơn",
  ...
  "session.tab.review": "Ôn tập",
  "session.tab.context": "Ngữ cảnh",
  "session.tab.unknown": "Phiên không xác định",
  "session.panel.reviewAndFiles": "Xem xét và tập tin",
  ...
  "session.review.filesChanged": "Tệp đã được thay đổi {{count}}",
  ...
  "session.review.noVcs": "Không Git Hệ thống kiểm soát phiên bản được phát hiện, các thay đổi không được hiển thị",
  ...
  "session.review.noUncommittedChanges": "Chưa có thay đổi nào chưa được cam kết",
  "session.review.noBranchChanges": "Chưa có thay đổi nhánh",
  "session.files.selectToOpen": "Chọn một tập tin để mở",
  "session.files.all": "Tất cả các tập tin",
  "session.files.empty": "Không có tập tin",
  ...
  "session.followupDock.summary.one": "{{count}} tin nhắn được xếp hàng đợi",
  "session.followupDock.summary.other": "{{count}} tin nhắn được xếp hàng đợi",
  "session.followupDock.sendNow": "Gửi ngay bây giờ",
  "session.followupDock.edit": "Biên tập",
  "session.followupDock.collapse": "Thu gọn tin nhắn xếp hàng đợi",
  "session.followupDock.expand": "Mở rộng tin nhắn được xếp hàng đợi",
  "session.revertDock.summary.one": "{{count}} tin nhắn được khôi phục",
  "session.revertDock.summary.other": "{{count}} tin nhắn được khôi phục",
  "session.revertDock.collapse": "Thu gọn tin nhắn đã khôi phục",
  "session.revertDock.expand": "Mở rộng tin nhắn được khôi phục",
  ...
  "session.header.reveal.finder": "Tiết lộ trong Finder",
  "session.header.reveal.fileExplorer": "Tiết lộ trong File Explorer",
  ...
  "terminal.connectionLost.abnormalClose": "WebSocket đóng cửa bất thường: {{code}}",
  ...
  "common.key.esc": "ESC",
  "common.key.ctrl": "Điều khiển",
  "common.key.alt": "thay thế",
  "common.key.shift": "Sự thay đổi",
  "common.key.meta": "Meta",
  "common.key.space": "Không gian",
  "common.key.backspace": "Phím lùi",
  "common.key.enter": "Đi vào",
  "common.key.tab": "Thẻ",
  "common.key.delete": "Xóa bỏ",
  "common.key.home": "Trang chủ",
  "common.key.end": "Kết thúc",
  "common.key.pageUp": "Trang lên",
  "common.key.pageDown": "Trang xuống",
  "common.key.insert": "Chèn",
  "common.unknown": "không rõ",
  "common.time.justNow": "Vừa rồi",
  "common.time.minutesAgo.short": "{{count}}m trước",
  "common.time.hoursAgo.short": "{{count}} giờ trước",
  "common.time.daysAgo.short": "{{count}}ngày trước",
  "sidebar.menu.toggle": "Chuyển đổi menu",
  "sidebar.nav.projectsAndSessions": "Dự án và phiên",
  "sidebar.settings": "Cài đặt",
  "sidebar.help": "Giúp đỡ",
  "sidebar.workspaces.enable": "Bật không gian làm việc",
  "sidebar.workspaces.disable": "Vô hiệu hóa không gian làm việc",
  ...
  "sidebar.gettingStarted.line2": "Kết nối bất kỳ nhà cung cấp nào để sử dụng models, inc. Claude, GPT, Gemini, v.v.",
  ...
  "settings.general.row.theme.description": "Tùy chỉnh cách OpenCode theo chủ đề.",
  ...
  "settings.general.row.uiFont.description": "Tùy chỉnh font chữ sử dụng xuyên suốt giao diện",
  "settings.general.row.followup.title": "Cách xử lý lời nhắc tiếp theo",
  "settings.general.row.followup.description": "Chọn xem lời nhắc tiếp theo sẽ được điều khiển ngay lập tức hay chờ trong hàng đợi",
  ...
  "settings.general.row.showCustomAgents.description": "Chuyển đổi giữa các tác nhân trong trình soạn thảo. Khi bị ẩn, mặc định là Tác nhân xây dựng.",
  ...
  "settings.general.row.shellToolPartsExpanded.title": "Mở rộng các bộ phận công cụ shell",
  ...
  "settings.updates.toast.latest.title": "Bạn đã cập nhật",
  ...
  "settings.providers.tag.custom": "Phong tục",
  ...
  "settings.mcp.description": "MCP cài đặt sẽ được định cấu hình tại đây.",
  ...
  "settings.permissions.tool.read.description": "Đọc một tập tin (khớp với đường dẫn tập tin)",
  "settings.permissions.tool.edit.title": "Biên tập",
  ...
  "settings.permissions.tool.list.description": "Liệt kê các tập tin trong một thư mục",
  "settings.permissions.tool.bash.title": "đánh",
  "settings.permissions.tool.bash.description": "Chạy lệnh shell",
  "settings.permissions.tool.task.title": "Nhiệm vụ",
  "settings.permissions.tool.task.description": "Ra mắt tác nhân phụ",
  ...
  "settings.permissions.tool.todowrite.title": "việc cần làm",
  ...
  "settings.permissions.tool.external_directory.description": "Truy cập các tập tin bên ngoài thư mục dự án",
  "settings.permissions.tool.doom_loop.title": "Vòng lặp diệt vong",
  ...
  "workspace.type.local": "địa phương",
  "workspace.type.sandbox": "hộp cát",

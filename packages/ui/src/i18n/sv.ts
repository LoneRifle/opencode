export const dict: Record<string, string> = {
  ...
  "ui.sessionReview.diffStyle.unified": "Sammanfogad",
  ...
  "ui.sessionReviewV2.unifiedDiff": "Sammanfogad diff",
  ...
  "ui.sessionReviewV2.empty.noGit.action": "Skapa Git-förråd",
  ...
  "ui.sessionTurn.retry.inSeconds": "i {{seconds}}s",
  "ui.sessionTurn.retry.attempt": "försök #{{attempt}}",
  "ui.sessionTurn.retry.attemptLine": "{{line}} - försök #{{attempt}}",
  "ui.sessionTurn.retry.geminiHot": "gemini är alldeles för het just nu",
  "ui.sessionTurn.error.freeUsageExceeded": "Fri användning har överskridits",
  ...
  "dialog.usageExceeded.accountRateLimit.title": "Go-gränsen nådd",
  ...
  "ui.sessionTurn.status.makingEdits": "Gör redigeringar",
  ...
  "ui.messagePart.questions.dismissed": "Frågor avvisade",
  "ui.messagePart.compaction": "Session komprimerad",
  "ui.messagePart.context.read.one": "{{count}} läst",
  "ui.messagePart.context.read.other": "{{count}} läsningar",
  "ui.messagePart.context.search.one": "{{count}} sök",
  ...
  "ui.toolErrorCard.copyError": "Kopieringsfel",
  ...
  "ui.message.forkMessage": "Förgrena till ny session",

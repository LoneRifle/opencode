export const dict = {
  ...
  "command.category.provider": "فراہم کرنے والا",
  ...
  "command.sidebar.toggle": "سائڈبار کو ٹوگل کریں۔",
  ...
  "command.provider.connect": "فراہم کنندہ سے رابطہ کریں۔",
  "command.server.switch": "سرور سوئچ کریں۔",
  ...
  "command.terminal.toggle": "ٹرمینل ٹوگل کریں۔",
  "command.fileTree.toggle": "فائل ٹری کو ٹوگل کریں۔",
  "command.review.toggle": "جائزہ ٹوگل کریں۔",
  "command.terminal.new": "نیا ٹرمینل",
  "command.terminal.new.description": "ایک نیا ٹرمینل ٹیب بنائیں",
  "command.steps.toggle": "اقدامات کو ٹوگل کریں۔",
  ...
  "command.mcp.toggle": "MCPs ٹوگل کریں۔",
  "command.mcp.toggle.description": "MCPs ٹوگل کریں۔",
  "command.agent.cycle": "سائیکل ایجنٹ",
  "command.agent.cycle.description": "اگلے ایجنٹ پر جائیں۔",
  "command.agent.cycle.reverse": "سائیکل ایجنٹ پیچھے کی طرف",
  "command.agent.cycle.reverse.description": "پچھلے ایجنٹ پر جائیں۔",
  "command.model.variant.cycle": "سائیکل سوچنے کی کوشش",
  "command.model.variant.cycle.description": "کوشش کی اگلی سطح پر جائیں۔",
  ...
  "command.workspace.toggle": "ورک اسپیس کو ٹوگل کریں۔",
  ...
  "dialog.provider.custom.label": "اپنی مرضی کے مطابق OpenAI- موافق فراہم کنندہ",
  ...
  "dialog.provider.openai.note": "تیز، قابل جنرل AI کاموں کے لیے GPT ماڈل",
  ...
  "dialog.model.empty": "کوئی ماڈل نتیجہ نہیں ہے۔",
  ...
  "provider.connect.status.inProgress": "اجازت دینے کا عمل جاری ہے...",
  "provider.connect.status.waiting": "اجازت کا انتظار ہے...",
  "provider.connect.status.failed": "اجازت دینے میں ناکام: {{error}}",
  ...
  "provider.connect.opencodeZen.visit.prefix": "وزٹ کریں۔",
  "provider.connect.opencodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.opencodeZen.visit.suffix": "اپنی API کلید جمع کرنے کے لیے۔",
  "provider.connect.oauth.code.visit.prefix": "وزٹ کریں۔",
  "provider.connect.oauth.code.visit.link": "یہ لنک",
  "provider.connect.oauth.code.visit.suffix": "اپنے اکاؤنٹ کو مربوط کرنے اور OpenCode میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنا اجازت نامہ جمع کرنے کے لیے۔",
  ...
  "provider.connect.oauth.auto.visit.prefix": "وزٹ کریں۔",
  "provider.connect.oauth.auto.visit.link": "یہ لنک",
  "provider.connect.oauth.auto.visit.suffix": "اور اپنا اکاؤنٹ منسلک کرنے کے لیے نیچے کوڈ درج کریں اور OpenCode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.custom.description.prefix": "ایک OpenAI- ہم آہنگ فراہم کنندہ کو ترتیب دیں۔ دیکھیں",
  "provider.custom.description.link": "فراہم کنندہ تشکیل دستاویزات",
  ...
  "provider.custom.field.apiKey.description": "اختیاری اگر آپ ہیڈر کے ذریعے تصدیق کا انتظام کرتے ہیں تو خالی چھوڑ دیں۔",
  ...
  "model.tooltip.provider": "فراہم کرنے والا",
  ...
  "common.goBack": "واپس نیویگیٹ کریں۔",
  "common.goForward": "آگے نیویگیٹ کریں۔",
  ...
  "prompt.placeholder.simple": "کچھ بھی پوچھو...",
  ...
  "session.child.promptDisabled": "سبجینٹ سیشنز کا اشارہ نہیں کیا جا سکتا۔",
  ...
  "prompt.example.22": "اس اختتامی نقطہ کے لیے کیشنگ کو لاگو کریں۔",
  ...
  "prompt.dropzone.file.label": "@ ذکر فائل پر ڈراپ کریں۔",
  ...
  "dialog.directory.root": "جڑ",
  "dialog.directory.parent": "والدین",
  "dialog.directory.readError": "اس فولڈر کو پڑھنے سے قاصر ہے۔",
  ...
  "dialog.releaseNotes.media.alt": "پیش نظارہ جاری کریں۔",
  "context.breakdown.title": "سیاق و سباق کی خرابی",
  "context.breakdown.note": "ان پٹ ٹوکنز کی تخمینی خرابی \"دیگر\" میں ٹول کی تعریفیں اور اوور ہیڈ شامل ہیں۔",
  ...
  "context.stats.provider": "فراہم کرنے والا",
  ...
  "toast.session.share.success.description": "URL کو کلپ بورڈ پر کاپی کیا گیا شیئر کریں!",
  ...
  "error.page.action.report": "رپورٹ کی خرابی",
  ...
  "error.chain.responseBody": "جوابی جسم:\n{{body}}",
  ...
  "error.chain.configDirectoryTypo": "{{path}} میں ڈائریکٹری \"{{dir}}\" درست نہیں ہے۔ ڈائرکٹری کا نام بدل کر \"{{suggestion}}\" رکھ دیں یا اسے ہٹا دیں۔ یہ ایک عام ٹائپنگ ہے۔",
  ...
  "notification.question.description": "{{projectName}} میں {{sessionTitle}} ایک سوال ہے۔",
  ...
  "home.server.collapse": "سرور پروجیکٹس کو ختم کریں۔",
  ...
  "session.error.notFound.closeTab": "Tab بند کریں۔",
  "session.error.serverConnection": "اس سرور سے منسلک نہیں ہو سکتا",
  "session.review.filesChanged": "فائلیں {{count}} تبدیل کر دی گئیں۔",
  ...
  "session.review.noBranchChanges": "ابھی تک کوئی برانچ تبدیل نہیں ہوئی ہے۔",
  ...
  "session.messages.renderEarlier": "پہلے کے پیغامات پیش کریں۔",
  ...
  "session.followupDock.summary.one": "{{count}} قطار میں بند پیغام",
  ...
  "session.revertDock.summary.one": "{{count}} رول بیک پیغام",
  "session.revertDock.summary.other": "{{count}} رول بیک پیغامات",
  "session.revertDock.collapse": "رول بیک پیغامات کو سکیڑیں۔",
  "session.revertDock.expand": "رول بیک پیغامات کو پھیلائیں۔",
  ...
  "session.new.workspace.runIn": "میں سیشن چلائیں۔",
  ...
  "session.header.openIn": "میں کھولیں۔",
  ...
  "session.header.reveal.containingFolder": "پر مشتمل فولڈر کھولیں۔",
  ...
  "session.share.action.unpublishing": "غیر اشاعت...",
  ...
  "sidebar.menu.toggle": "مینو کو ٹوگل کریں۔",
  ...
  "debugBar.nav.tip": "سیشن کے صفحے کو چھوتے ہوئے آخری مکمل روٹ کی منتقلی، روٹر کے شروع ہونے سے پہلے پینٹ کے ٹھیک ہونے تک ماپا جاتا ہے۔",
  ...
  "settings.general.section.advanced": "اعلی درجے کی",
  ...
  "settings.general.row.shell.title": "Terminal شیل",
  ...
  "settings.general.row.theme.description": "اپنی مرضی کے مطابق بنائیں کہ کس طرح OpenCode تھیم ہے۔",
  ...
  "settings.general.row.showCustomAgents.description": "کمپوزر میں ایجنٹوں کے درمیان سوئچ کریں۔ پوشیدہ ہونے پر، ایجنٹ بنانے کے لیے ڈیفالٹس۔",
  ...
  "settings.general.row.shellToolPartsExpanded.title": "شیل ٹول کے پرزوں کو پھیلائیں۔",
  "settings.general.row.shellToolPartsExpanded.description": "ٹائم لائن میں بطور ڈیفالٹ توسیع شدہ شیل ٹول کے پرزے دکھائیں۔",
  "settings.general.row.editToolPartsExpanded.title": "ترمیمی ٹول کے پرزوں کو پھیلائیں۔",
  "settings.general.row.editToolPartsExpanded.description": "ٹائم لائن میں بطور ڈیفالٹ توسیع شدہ ترمیم، تحریر، اور پیچ ٹول کے پرزے دکھائیں۔",
  ...
  "settings.general.row.newInterfaceNotice.dismiss": "برطرف کرنا",
  ...
  "settings.shortcuts.group.general": "جنرل",
  ...
  "settings.providers.tag.environment": "ماحولیات",
  ...
  "settings.permissions.action.ask": "پوچھو",
  ...
  "settings.permissions.tool.task.description": "ذیلی ایجنٹوں کو شروع کریں۔",
  ...
  "workspace.resetting.title": "ورک اسپیس کو ری سیٹ کرنا",
  ...
  "workspace.status.clean": "غیر ضم شدہ تبدیلیوں کا پتہ نہیں چلا۔",
  "workspace.status.dirty": "اس ورک اسپیس میں غیر مربوط تبدیلیوں کا پتہ چلا۔",
  ...
  "workspace.reset.archived.one": "1 سیشن کو محفوظ کیا جائے گا۔",
  "workspace.reset.archived.many": "{{count}} سیشنز کو محفوظ کیا جائے گا۔",

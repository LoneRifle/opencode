...
import { dict as desktopTzm } from "./tzm"
...
import { dict as appTzm } from "../../../../app/src/i18n/tzm"
...
function detectLocale(): Locale {
  ...
  for (const language of languages) {
    ...
    if (language.toLowerCase().startsWith("tzm")) return "tzm"
...
function build(locale: Locale): Dictionary {
  ...
  if (locale === "tzm") return { ...base, ...i18n.flatten(appTzm), ...i18n.flatten(desktopTzm) }

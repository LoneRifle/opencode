export const dict = {
  ...
  "command.sidebar.toggle": "Zijbalk schakelen",
  ...
  "command.provider.connect": "Verbind aanbieder",
  "command.server.switch": "Wissel van server",
  ...
  "command.tab.reopenClosed": "Open het gesloten tabblad opnieuw",
  ...
  "command.mcp.toggle": "Schakel MCP's in",
  "command.mcp.toggle.description": "Schakel MCP's in",
  ...
  "command.workspace.toggle": "Schakel tussen werkruimten",
  ...
  "palette.search.placeholder.home": "Zoekopdrachten en sessies",
  ...
  "dialog.provider.custom.label": "Aangepaste OpenAI-compatibele provider",
  ...
  "dialog.provider.openrouter.note": "Toegang tot alle ondersteunde modellen van één provider",
  ...
  "dialog.model.manage.provider.toggle": "Schakel alle {{provider}}-modellen in",
  ...
  "provider.connect.title": "Sluit {{provider}} aan",
  ...
  "provider.connect.status.waiting": "Wachten op toestemming...",
  ...
  "provider.connect.toast.connected.title": "{{provider}} aangesloten",
  ...
  "provider.custom.description.prefix": "Configureer een OpenAI-compatibele provider. Bekijk de ",
  "provider.custom.description.link": "configuratiedocumenten van de provider",
  ...
  "provider.disconnect.toast.disconnected.title": "{{provider}} verbinding verbroken",
  ...
  "common.goBack": "Navigeer terug",
  "common.goForward": "Navigeer vooruit",
  ...
  "common.disconnect": "Verbreek de verbinding",
  ...
  "prompt.placeholder.summarizeComment": "Commentaar samenvatten...",
  "prompt.mode.shell": "Shell",
  "prompt.mode.normal": "Prompt",
  "prompt.mode.shell.exit": "esc om af te sluiten",
  "session.child.promptDisabled": "Subagentsessies kunnen niet worden gevraagd.",
  ...
  "prompt.example.9": "Help mij dit probleem op te lossen",
  ...
  "prompt.example.13": "Maak een nieuw onderdeel voor...",
  ...
  "prompt.dropzone.file.label": "Loslaten om bestand met @ te vermelden",
  ...
  "dialog.fork.empty": "Geen berichten om uit te splitsen",
  ...
  "dialog.server.edit.title": "Bewerk server",
  ...
  "wsl.server.addShort": "Voeg WSL toe",
  "wsl.server.label": "WSL",
  "wsl.server.menu.label": "WSL-server",
  "wsl.server.retryStart": "Probeer opnieuw te starten",
  ...
  "wsl.onboarding.listingDistros": "Distributies vermelden...",
  ...
  "context.breakdown.tool": "Gereedschapsoproepen",
  "context.breakdown.other": "Anders",
  ...
  "context.stats.assistantMessages": "Assistent-berichten",
  ...
  "toast.permissions.autoaccept.on.title": "Auto-acceptatie van machtigingen",
  "toast.permissions.autoaccept.on.description": "Toestemmingsverzoeken worden automatisch goedgekeurd",
  "toast.permissions.autoaccept.off.title": "Het automatisch accepteren van machtigingen is gestopt",
  "toast.permissions.autoaccept.off.description": "Voor verzoeken om toestemming is goedkeuring vereist",
  "toast.model.none.title": "Geen model geselecteerd",
  "toast.model.none.description": "Sluit een provider aan om deze sessie samen te vatten",
  ...
  "error.chain.responseBody": "Reactietekst:\n{{body}}",
  ...
  "error.chain.providerAuthFailed": "Providerverificatie mislukt ({{provider}}): {{message}}",
  ...
  "error.chain.configDirectoryTypo":
    'Directory "{{dir}}" in {{path}} is niet geldig. Hernoem de map naar "{{suggestion}}" of verwijder deze. Dit is een veel voorkomende typefout.',
  ...
  "home.server.expand": "Vouw serverprojecten uit",
  ...
  "session.review.filesChanged": "Bestanden gewijzigd {{count}}",
  "session.review.change.one": "Verandering",
  "session.review.change.other": "Veranderingen",
  ...
  "session.todo.expand": "Uitbreiden",
  ...
  "session.followupDock.expand": "Vouw berichten in de wachtrij uit",
  ...
  "session.revertDock.expand": "Vouw teruggedraaide berichten uit",
  ...
  "session.new.workspace.runIn": "Sessie uitvoeren",
  ...
  "session.header.openIn": "Open binnen",
  ...
  "session.header.reveal.finder": "Onthul in Finder",
  "session.header.reveal.fileExplorer": "Onthullen in Verkenner",
  "session.header.reveal.containingFolder": "Open de bevattende map",
  ...
  "session.share.popover.description.shared":
    "Deze sessie is openbaar op internet. Het is toegankelijk voor iedereen met de link.",
  "session.share.popover.description.unshared":
    "Deel de sessie openbaar op internet. Het is toegankelijk voor iedereen met de link.",
  ...
  "sidebar.gettingStarted.line2": "Sluit elke provider aan om modellen te gebruiken, inc. Claude, GPT, Gemini enz.",
  ...
  "debugBar.ariaLabel": "Diagnostiek van ontwikkelingsprestaties",
  "debugBar.na": "n.v.t",
  "debugBar.nav.label": "NAV",
  "debugBar.nav.tip":
    "Laatst voltooide routeovergang waarbij een sessiepagina werd aangeraakt, gemeten vanaf het starten van de router tot de eerste verf nadat deze is neergedaald.",
  "debugBar.fps.label": "FPS",
  "debugBar.fps.tip": "Rollende frames per seconde gedurende de afgelopen 5 seconden.",
  "debugBar.frame.label": "KADER",
  ...
  "debugBar.cls.tip": "Cumulatieve lay-outverschuiving voor de huidige levensduur van de app.",
  "debugBar.mem.label": "MEM",
  "debugBar.mem.tipUnavailable": "Gebruikte JS-heap versus heap-limiet. Alleen Chromium.",
  "debugBar.mem.tip": "Gebruikte JS-heap versus heap-limiet. {{used}} of {{limit}}.",
  ...
  "settings.general.row.colorScheme.description":
    "Kies of OpenCode het systeemthema, lichte thema of donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van de OpenCode aan.",
  ...
  "settings.general.row.followup.description":
    "Kies of vervolgmeldingen onmiddellijk sturen of in een wachtrij wachten",
  ...
  "settings.general.row.showFileTree.description": "Toon het bestandsboompaneel in sessies",
  ...
  "settings.general.row.showSearch.description": "Toon de zoek- en opdrachtpaletknop in de titelbalk",
  ...
  "settings.general.row.shellToolPartsExpanded.title": "Vouw shell-gereedschapsonderdelen uit",
  "settings.general.row.shellToolPartsExpanded.description":
    "Toon shell-gereedschapsonderdelen standaard uitgevouwen in de tijdlijn",
  "settings.general.row.editToolPartsExpanded.title": "Vouw de bewerkingstoolonderdelen uit",
  ...
  "settings.general.row.wayland.tooltip":
    "Op Linux met monitoren met gemengde vernieuwingsfrequentie kan de native Wayland stabieler zijn.",
  "settings.general.row.releaseNotes.title": "Release-opmerkingen",
  ...
  "settings.providers.description": "Providerinstellingen kunnen hier worden geconfigureerd.",
  "settings.providers.section.connected": "Verbonden aanbieders",
  "settings.providers.connected.empty": "Geen aangesloten providers",
  ...
  "settings.providers.custom.description": "Voeg een OpenAI-compatibele provider toe via de basis-URL.",
  ...
  "settings.permissions.section.tools": "Gereedschap",
  "settings.permissions.toast.updateFailed.title": "Kan rechten niet updaten",
  "settings.permissions.action.allow": "Toestaan",
  "settings.permissions.action.ask": "Vraag",
  ...
  "settings.permissions.tool.glob.description": "Match bestanden met glob-patronen",
  ...
  "settings.permissions.tool.doom_loop.description": "Detecteer herhaalde gereedschapsoproepen met identieke invoer",

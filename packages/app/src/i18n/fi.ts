export const dict = {
  "command.category.suggested": "Ehdotettu",
  ...
  "command.agent.cycle.reverse": "Kierrä agentti taaksepäin",
  "command.agent.cycle.reverse.description": "Vaihda edelliseen agenttiin",
  "command.model.variant.cycle": "Kierrä ajatteluponnistusta",
  "command.model.variant.cycle.description": "Vaihda seuraavalle ponnistustasolle",
  ...
  "dialog.provider.group.popular": "Suosittu",
  "dialog.provider.group.other": "Muut",
  "dialog.provider.custom.label": "Mukautettu OpenAI-yhteensopiva palveluntarjoaja",
  "dialog.provider.tag.recommended": "Suositeltava",
  "dialog.provider.opencode.note": "Kuratoituja malleja, kuten Claude, GPT ja Gemini",
  ...
  "dialog.provider.google.note": "Gemini-mallit nopeaan, jäsenneltyyn vastaukseen",
  ...
  "dialog.model.manage.provider.toggle": "Ota käyttöön kaikki {{provider}} mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}} API-avaimesi yhdistääksesi tilisi ja käytä {{provider}}-malleja OpenCodessa.",
  ...
  "provider.connect.opencodeZen.visit.prefix": "Vieraile",
  "provider.connect.opencodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.opencodeZen.visit.suffix": "noutaaksesi API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Vieraile",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    "kerätäksesi valtuutuskoodisi tilisi yhdistämiseksi ja {{provider}}-mallien käyttämiseksi OpenCodessa.",
  ...
  "provider.connect.oauth.auto.visit.prefix": "Vieraile",
  ...
  "provider.custom.field.name.placeholder": "Minun AI-palveluntarjoajani",
  ...
  "provider.custom.field.apiKey.description": "Valinnainen. Jätä tyhjäksi, jos hallitset todennusta otsikoiden kautta.",
  ...
  "model.tooltip.reasoning.none": "Ei perusteluja",
  "model.tooltip.context": "Kontekstirajoitus {{limit}}",
  "common.search.placeholder": "Etsi",
  "common.goBack": "Navigoi takaisin",
  "common.goForward": "Navigoi eteenpäin",
  ...
  "prompt.placeholder.simple": "Kysy mitä vaan...",
  ...
  "prompt.example.12": "Lisää syötteen vahvistus",
  ...
  "prompt.example.17": "Selitä tämä regex-malli",
  ...
  "dialog.server.menu.defaultRemove": "Poista oletusarvo",
  ...
  "wsl.server.retryStart": "Aloita uudelleen",
  "wsl.server.updating": "Päivitetään...",
  "wsl.onboarding.step.distro": "Valitse distro",
  ...
  "wsl.onboarding.listingDistros": "Listataan distroja...",
  ...
  "wsl.onboarding.pickDistro": "Valitse distro tai asenna sellainen alta.",
  ...
  "wsl.onboarding.updateOpencodeIn": "Päivitä OpenCode: {{distro}}.",
  ...
  "wsl.onboarding.chooseDistroFirst": "Valitse ensin distro.",
  "wsl.onboarding.loadFailed": "WSL-tilan lataaminen epäonnistui.",
  "wsl.onboarding.loading": "Ladataan...",
  "wsl.onboarding.installedDistros": "Asennettuja distroja",
  ...
  "wsl.onboarding.wslNotInstalled.title": "WSL ei asennettu",
  ...
  "dialog.project.edit.color.select": "Valitse {{color}} väri",
  ...
  "dialog.releaseNotes.action.next": "Seuraavaksi",
  ...
  "context.breakdown.note":
    'Syötetokenien arvioitu jakautuminen. "Muut" sisältää työkalumäärittelyt ja muun yleiskulun.',
  ...
  "context.stats.lastActivity": "Viimeinen toiminta",
  ...
  "toast.language.description": "Vaihdettu kielelle {{language}}",
  "toast.theme.title": "Teema vaihdettu",
  "toast.scheme.title": "Värimaailma",
  ...
  "toast.session.unshare.failed.title": "Istunnon jaon poistaminen epäonnistui",
  ...
  "toast.project.reloadFailed.title": "{{project}} uudelleenlataus epäonnistui",
  ...
  "error.childStore.persistedProjectMetadataCreateFailed": "Pysyvien projektin metatietojen luominen epäonnistui",
  ...
  "error.chain.configDirectoryTypo":
    'Hakemisto "{{dir}}" paikassa {{path}} ei kelpaa. Nimeä hakemisto uudelleen nimellä "{{suggestion}}" tai poista se. Tämä on yleinen kirjoitusvirhe.',
  "error.chain.configFrontmatterError": "Polun {{path}} front matter -tietojen jäsentäminen epäonnistui:\n{{message}}",
  "error.chain.configInvalid": "Määritystiedosto osoitteessa {{path}} on virheellinen",
  "error.chain.configInvalidWithMessage": "Määritystiedosto osoitteessa {{path}} on virheellinen: {{message}}",
  ...
  "notification.action.goToSession": "Mene istuntoon",
  ...
  "home.server.collapse": "Kutista palvelinprojektit",
  "home.server.expand": "Laajenna palvelinprojekteja",
  "home.sessions.search.placeholder": "Hae istuntoja",
  "home.sessions.search.placeholder.scoped": "Hae istuntoja {{scope}}",
  ...
  "session.review.noVcs.createGit.title": "Luo Git-repository",
  "session.review.noVcs.createGit.description": "Seuraa, tarkista ja kumoa muutoksia tässä projektissa",
  "session.review.noVcs.createGit.actionLoading": "Luodaan Git-repositorya...",
  "session.review.noVcs.createGit.action": "Luo Git-repository",
  "session.review.noSnapshot":
    "Snapshot-seuranta on poistettu käytöstä määrityksessä, joten istunnon muutokset eivät ole käytettävissä",
  ...
  "session.messages.renderEarlier": "Renderöi aikaisemmat viestit",
  ...
  "session.question.minimize": "Minimoi kysymys",
  ...
  "session.followupDock.summary.one": "{{count}} jonossa olevaa viestiä",
  ...
  "session.revertDock.summary.one": "{{count}} palautettua viestiä",
  ...
  "session.new.workspace.local": "Paikallinen repository",
  ...
  "session.header.open.menu": "Avaa vaihtoehdot",
  ...
  "session.header.reveal.containingFolder": "Avaa sisältävä kansio",
  ...
  "terminal.connectionLost.abnormalClose": "WebSocket suljettu epänormaalisti: {{code}}",
  "terminal.connectionLost.description": "Pääteyhteys katkesi. Tämä voi tapahtua, kun palvelin käynnistyy uudelleen.",
  ...
  "common.time.daysAgo.short": "{{count}} p sitten",
  "sidebar.menu.toggle": "Vaihda valikkoa",
  ...
  "debugBar.nav.tip":
    "Viimeisin suoritettu reitin siirto, joka koskettaa istuntosivua, mitattuna reitittimen alusta ensimmäiseen maaliin sen asettumisen jälkeen.",
  "debugBar.fps.label": "FPS",
  "debugBar.fps.tip": "Rullaavat kuvat sekunnissa viimeisen 5 sekunnin aikana.",
  "debugBar.frame.label": "FRAME",
  "debugBar.frame.tip": "Huonoin kuva-aika viimeisen 5 sekunnin aikana.",
  "debugBar.jank.label": "JANK",
  "debugBar.jank.tip": "Kuvat yli 32 ms viimeisen 5 sekunnin aikana.",
  "debugBar.long.label": "PITKÄ",
  "debugBar.long.tip":
    "Estetty aika ja pitkien tehtävien määrä viimeisen 5 sekunnin aikana. Tehtävän enimmäismäärä: {{max}}.",
  "debugBar.delay.label": "VIIVE",
  "debugBar.delay.tip": "Huonoin havaittu tuloviive viimeisen 5 sekunnin aikana.",
  "debugBar.inp.label": "INP",
  "debugBar.inp.tip":
    "Vuorovaikutuksen arvioitu kesto viimeisen 5 sekunnin ajalta. Tämä on INP-tyyppinen, ei virallinen Web Vitals INP.",
  "debugBar.cls.label": "CLS",
  "debugBar.cls.tip": "Kumulatiivinen asettelun muutos nykyisen sovelluksen käyttöiän aikana.",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä OpenCode näyttää laitteessasi",
  "settings.general.row.colorScheme.title": "Värimaailma",
  "settings.general.row.colorScheme.description": "Valitse, seuraako OpenCode järjestelmä-, vaaleaa vai tummaa teemaa",
  ...
  "settings.general.row.terminalFont.title": "Päätteen fontti",
  "settings.general.row.terminalFont.description": "Mukauta terminaalissa käytettävä fontti",
  "settings.general.row.uiFont.title": "Käyttöliittymän kirjasin",
  ...
  "settings.general.row.showTerminal.description": "Näytä päätepainike työpöydän otsikkorivillä",
  ...
  "settings.general.row.showCustomAgents.title": "Näytä agentti",
  "settings.general.row.showCustomAgents.description":
    "Vaihda agenttien välillä viestikentässä. Piilotettuna käytetään oletuksena Build-agenttia.",
  "settings.general.row.reasoningSummaries.title": "Näytä perustelujen yhteenvedot",
  "settings.general.row.reasoningSummaries.description": "Näytä mallin perustelujen yhteenvedot aikajanalla",
  ...
  "settings.general.row.editToolPartsExpanded.title": "Laajenna muokkaustyökalun osia",
  "settings.general.row.editToolPartsExpanded.description":
    "Näytä oletusarvoisesti laajennetut muokkaus-, kirjoitus- ja korjaustyökalun osat aikajanalla",
  ...
  "settings.general.row.pinchZoom.description": "Salli ohjauslevyn nipistäminen ja Ctrl-vieritys-eleiden zoomaus",
  ...
  "settings.general.row.wayland.tooltip":
    "Linuxissa, jossa on sekoitettu virkistystaajuusmonitori, alkuperäinen Wayland voi olla vakaampi.",
  ...
  "settings.providers.connected.environmentDescription": "Yhdistetty ympäristömuuttujiisi",
  ...
  "settings.permissions.tool.edit.description":
    "Muokkaa tiedostoja, mukaan lukien muokkaukset, kirjoitukset ja korjaukset",
  "settings.permissions.tool.glob.title": "Glob",
  "settings.permissions.tool.glob.description": "Yhdistä tiedostoja glob-kuvioiden avulla",
  "settings.permissions.tool.grep.title": "Grep",
  "settings.permissions.tool.grep.description": "Hae tiedoston sisältöä säännöllisten lausekkeiden avulla",
  ...
  "settings.permissions.tool.todowrite.title": "Tehtävälistan kirjoitus",
  ...
  "workspace.resetting.title": "Nollataan työtilaa",
  "workspace.resetting.description": "Tämä voi kestää minuutin.",
  "workspace.reset.failed.title": "Työtilan nollaaminen epäonnistui",
  "workspace.reset.success.title": "Työtilan nollaus",

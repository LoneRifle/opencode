export const dict = {
  ...
  "desktop.updater.downloaded.prompt": "OpenCode का संस्करण {{version}} डाउनलोड हो गया है, क्या आप इसे इंस्टॉल करना और पुनः लॉन्च करना चाहेंगे?",
  ...
  "desktop.cli.failed.message": "CLI: {{error}} स्थापित करने में विफल",
}

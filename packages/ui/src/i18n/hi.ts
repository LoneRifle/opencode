export const dict: Record<string, string> = {
  ...
  "ui.sessionReview.change.removed": "निकाला गया",
  ...
  "ui.sessionReviewV2.empty.noGit.actionLoading": "Git रिपॉजिटरी बनाया जा रहा है...",
  ...
  "ui.fileMedia.state.error": "{{kind}} लोड करने में असमर्थ.",
  "ui.fileMedia.state.unavailable": "{{kind}} पूर्वावलोकन अनुपलब्ध है.",
  ...
  "ui.sessionTurn.diffs.showAll": "सब दिखाएं",
  ...
  "dialog.usageExceeded.freeTier.description": "$5/month से शुरू करके सर्वोत्तम ओपन-सोर्स मॉडल तक विश्वसनीय पहुंच के लिए OpenCode Go की सदस्यता लें।",
  "dialog.usageExceeded.freeTier.actionLabel": "सदस्यता लें",
  "dialog.usageExceeded.accountRateLimit.title": "Go सीमा पूरी हो गई",
  "dialog.usageExceeded.accountRateLimit.description": "उपयोग की सीमा पूरी हो गई. अब इस मॉडल का उपयोग जारी रखने के लिए, अपने उपलब्ध शेष राशि से उपयोग सक्षम करें",
  ...
  "ui.messagePart.context.read.one": "{{count}} पढ़ें",
  "ui.messagePart.context.read.other": "{{count}} रीड",
  "ui.messagePart.context.search.one": "{{count}} खोजें",
  ...
  "ui.messageNav.newMessage": "नया सन्देश",
  ...
  "ui.message.copy": "प्रतिलिपि",
  "ui.message.copyMessage": "संदेश कॉपी करें",
  "ui.message.forkMessage": "फ़ोर्क से नया सेशन",
